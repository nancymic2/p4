...
value="44"><br>
<a href="#" onclick='window.open("/companysmall", "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=200, left=100, width=400, height=400, menubar=no, status=no, titlebar=no, toolbar=no" );'>Add a company</a>
