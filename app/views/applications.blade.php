...
<a href="#" onclick='document.getElementById("companyhide2").style.display="none"; document.getElementById("companyhideDB").style.display="block"; '>Or add one of your existing companies</a>
