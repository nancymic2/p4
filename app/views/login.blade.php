...
<div id="alert" style="z-index: 90; padding: 10px; border-radius: 12px; width: 300px; height: 100px; color: white; background-color: #9172EC; display:none; position: relative; top: 10px; left: 10px;">Your hsfhakldd</div>
